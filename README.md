...
**Nerocash (TERM)** is an innovative, decentralized cryptocurrency designed to function as a primary medium of exchange. Nerocash provides a secure, transparent, and immutable ledger for global peer-to-peer transactions.
...
Nerocash Core by default uses port `9883` for peer-to-peer communication that
