...
/** Recommended transaction fee by Nerocash Core developers
  *
 ...
 *
 *  Nerocash:    Increment mempool limits and accept RBF in steps of 0.0001 TERM
...
/**
 * Nerocash: Default dust limit that is evaluated when considering whether a
...
/**
 * Nerocash: Default hard dust limit that is evaluated when considering whether
