...
This tutorial will help you to go through the basics to use Nerocash Core after you completed the [installation instructions](/INSTALL.md). You now have `nerocashd` or `nerocash-qt` executables available to run a node, and `nerocash-cli`/`nerocash-tx` tools to help you transact TERM.
