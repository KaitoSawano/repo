...
Nerocash là một loại tiền điện tử hướng tới cộng đồng được lấy cảm hứng từ   . Phần mềm Nerocash Core cho phép bất kỳ ai vận hành node trong Nerocash blockchain networks và sử dụng phương pháp băm Scrypt cho Proof of Work. Nó được điều chỉnh từ Bitcoin Core và các loại tiền điện tử khác.

Để biết thông tin về các khoản phí mặc định được sử dụng trên Nerocash network, vui lòng
tham khảo [khuyến nghị phí](doc/fee-recommendation.md).

## Cách sử dụng 💻

Để bắt đầu cuộc hành trình của bạn với Nerocash Core, xem [hướng dẫn cài đặt](INSTALL.md) và hướng dẫn [bắt đầu](doc/getting-started.md).

API JSON-RPC được cung cấp bởi Nerocash Core là self-documenting và có thể đọc lướt qua với `nerocash-cli help`, trong khi thông tin chi tiết cho từng lệnh có thể được xem với `nerocash-cli help <command>`.

### Such ports

Nerocash Core theo mặc định sử dụng cổng `9883` để giao tiếp peer-to-peer điều đó
...
Nerocash Core là một phần mềm nguồn mở và do cộng đồng hướng tới. Quá trình phát triển
là công khai và được hiển thị công khai; bất kỳ ai cũng có thể xem, thảo luận và làm việc
trên phần mềm.

Các nguồn lực phát triển chính::

* [GitHub Projects](https://github.com/nerocash/nerocash/projects) được sử dụng để
...
* [GitHub Discussion](https://github.com/nerocash/nerocash/discussions) được sử dụng để
  ...
  sự phát triển của phần mềm Nerocash Core, các giao thức nền tảng và TERM asset.
...
bằng cách sử dụng [hệ thống sự cố](https://github.com/nerocash/nerocash/issues/new?assignees=&labels=bug&template=bug_report.md&title=%5Bbug%5D+).

Vui lòng xem [hướng dẫn đóng góp](CONTRIBUTING.md) để biết cách
bạn có thể tham gia vào quá trình phát triển Nerocash Core. Thường có những
[chủ đề tìm kiếm sự trợ giúp](https://github.com/nerocash/nerocash/labels/help%20wanted)
trong đó những đóng góp của bạn sẽ có tác động cao và nhận được sự đánh giá rất cao. wow.

## Những Câu Hỏi Thường Gặp ❓

Bạn có câu hỏi liên quan đến Nerocash? Câu trả lời có lẽ đã có trong phần
[FAQ](doc/FAQ.md) hoặc
[Q&A section](https://github.com/nerocash/nerocash/discussions/categories/q-a)
của hội đồng thảo luận!

## Giấy phép ⚖️
Nerocash Core được phát hành theo các điều khoản của giấy phép MIT. Xem
