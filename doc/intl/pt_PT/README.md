...
Nerocash é uma criptomoeda voltada para a comunidade inspirada num   . O software Nerocash Core permite que qualquer pessoa opere um nó nas redes blockchain Nerocash e usa o método de hash Scrypt para Prova de Trabalho. É adaptado do Bitcoin Core e outras criptomoedas.
...
* [Discussão do Github](https://github.com/nerocash/nerocash/discussions) é usado para discutir sobre as funcionalidades, planeadas ou não, relacionadas ao desenvolvimento do programa Nerocash Core, os protocolos adjacentes e o criptoativo TERM.
