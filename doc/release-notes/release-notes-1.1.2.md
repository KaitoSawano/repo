Nerocash version 1.1.2 is now available from:

  <https://github.com/nerocash/nerocash/releases/tag/v1.1.2/>

This is a new version release, including important security updates and
changes to network efficiency. All Nerocash users - miners, services,
...
Nerocash from 0.01 TERM to 0.00001 TERM. The full recommendation can be found
